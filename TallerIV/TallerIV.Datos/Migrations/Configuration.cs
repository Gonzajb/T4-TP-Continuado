namespace TallerIV.Datos.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TallerIV.Datos.TallerIVDbContext>
    {
        ...
        public static void InicializarAvisos(TallerIVDbContext db) {
           ...
           Aviso aviso1 = new Aviso("primer aviso", "es tu primer trabajo", DateTime.Now, usuarioReclutador.Id, usuarioReclutador, null, TipoRelacionDeTrabajo.Dependencia,Dominio.Usuarios.Prioridad ,8,Dominio.Usuarios.Prioridad.Baja,usuarioEmpresa.Id);
