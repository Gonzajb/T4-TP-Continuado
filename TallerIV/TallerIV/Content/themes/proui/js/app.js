...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('.input-datepicker, .input-daterange').datepicker({ weekStart: 1, autoclose: true, language: 'es' });
        $('.input-datepicker-close').datepicker({weekStart: 1}).on('changeDate', function(e){ $(this).datepicker('hide'); });

        // Initialize Timepicker
        $('.input-timepicker').timepicker({ minuteStep: 15, showSeconds: false, showMeridian: true });
        $('.input-timepicker24').timepicker({minuteStep: 15, showSeconds: false, showMeridian: false});
